...
public abstract class TransformationRuleParser {
	 ...
	 * @return EPL query
	 */
	public abstract String parseRule(TransformationPatternTree patternTree, Map<String, String> attributeIdentifiersAndExpressions, Map<String, ExternalKnowledgeExpressionSet> attributeIdentifiersAndExpressionSets);
	 ...
	 * an EPL query.
	 *
	 * @param externalKnowledge sets of expressions determining the fetch of external
	 *                          knowledge
