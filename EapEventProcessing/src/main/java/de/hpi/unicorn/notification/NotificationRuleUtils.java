...
public final class NotificationRuleUtils {
	 ...
	 */
	private static Object getRootValue(final Map<Object, Serializable> eventObject, final JSONObject event, final String key) throws UnsupportedJsonTransformation {
		return getRootValueInternal(event, key.split(EVENT_KEY_HIRARCHY_SEPERATOR), 0, eventObject.get(key));
	}
	 ...
	 * @throws UnsupportedJsonTransformation
	 */
	private static Object getRootValueInternal(final JSONObject object, final String[] keys, int iterator, final Object value) throws UnsupportedJsonTransformation {
		Object returnObject;
	 ...
	 * @throws UnsupportedJsonTransformation
	 */
	private static Object combineValue(final JSONObject object, final String[] keys, int iterator, final Object value) throws UnsupportedJsonTransformation {
		...
		if (((JSONObject) valueToCombine).containsKey(keys[iterator])) {
			((JSONObject) valueToCombine).put(keys[iterator], getRootValueInternal((JSONObject) valueToCombine, keys, iterator, value));
		} else {
