...
public class ComplexProcessTest extends AbstractQueryCreationTest {
	...
	public void setup() {
		...
		this.filePath = System.getProperty("user.dir") + "/src/test/resources/bpmn/ComplexProcessTest.bpmn20.xml";
	}
	...
	protected Set<EapEventType> createEventTypes() {
		...
		values = this.createAttributeTree();
		final EapEventType task7 = new EapEventType("Task7", values, "Timestamp");
