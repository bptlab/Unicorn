...
public abstract class AbstractEapPage extends WebPage {
	...
	private Component newQueriesDropDownButton() {
		...
		if (EapConfiguration.supportingOnDemandQueries) {
			button.addButton(new MenuBookmarkablePageLink<OnDemandQueryEditor>(OnDemandQueryEditor.class, Model.of("On-Demand")).setIconType(IconType.handleft));
		}
		button.addButton(new MenuBookmarkablePageLink<LiveQueryEditor>(LiveQueryEditor.class, Model.of("Live")).setIconType(IconType.time));
		// .addButton(
	...
	private Component newMonitoringDropDownButton() {
		return new NavBarDropDownButton(Model.of("Monitoring")).addButton(new MenuBookmarkablePageLink<BPMNMonitoringPage>(BPMNMonitoringPage.class, Model.of("BPMN")).setIconType(IconType.leaf)).addButton(new MenuBookmarkablePageLink<AttributeChartPage>(AttributeChartPage.class, Model.of("Attribute Charts"))).addButton(new MenuBookmarkablePageLink<EventViewPage>(EventViewPage.class, Model.of("Event Views"))).setIconType(IconType.camera).add(new DropDownAutoOpen());
	}
