...
export CATALINA_OPTS="-Ddb.host=$UNICORN_DB_HOST -Ddb.port=$UNICORN_DB_PORT -Ddb.dev.name=$UNICORN_DB_DEV_DB -Ddb.user=$UNICORN_DB_USER -Ddb.passw=$UNICORN_DB_PASSWORD"
catalina.sh run
